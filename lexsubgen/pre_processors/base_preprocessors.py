...
# 遍历输入的句子列表，将每个句子中的每个单词转换为小写，目标词索引保持不变
...
# 遍历输入的句子列表，将每个句子的第一个单词首字母大写，目标词索引保持不变。
...
# 遍历输入的句子列表和目标词索引列表，如果目标词是句子的第一个单词，则在句子开头添加 And 或 and，并更新目标词索引。
...
# 遍历输入的句子列表和目标词索引列表，在每个句子的开头添加填充文本，并更新目标词索引。
...
# 遍历输入的句子列表和目标词索引列表，将每个句子与其副本连接起来，并更新目标词索引。
...
# 遍历输入的句子列表和目标词索引列表，将每个句子与其副本连接两次，并更新目标词索引。
